...
Persistierung ohne Eingabedokument aus.
...
Geburtsdaten und damit unterschiedliche Hashes. `ground_truth.json`,
...
PNG-Neukodierung durch plattformspezifische Pillow-/matplotlib-Builds).

Stand 2026-08-27 besteht die vollständige Testsuite zusammen mit
